...
<div class="po-help-tip">Se você é Contractor, existe ainda uma aba <strong>Plano de Corte</strong>, com a lista técnica de corte/produção gerada a partir dos pedidos — ela só aparece pra esse perfil.</div>` },
    { id: 'conta-idioma-unidade', title: `Conta, idioma e unidade de medida`, html: `<img src="assets/help/configuracoes.jpg" alt="Painel de Configurações, com os seletores de idioma e unidade de medida" loading="lazy"><p>Para usar o portal você precisa de uma conta. Se ainda não tiver uma, clique em <strong>Entrar</strong> no topo da tela, depois em <strong>Criar conta</strong> e preencha nome, e-mail, telefone e senha. Já tem conta? Preencha e-mail e senha e clique em <strong>Entrar</strong> — ou use o botão <strong>Continuar com Google</strong> pra entrar mais rápido, se essa opção estiver disponível.</p>
...
<div class="po-help-tip">A pill <strong>Todas</strong>, no fim de cada barra de filtro, limpa aquele filtro específico e volta a mostrar todos os módulos daquele nível.</div>` },
    { id: 'medidas-cores-preco', title: `Medidas, cores e preço do módulo`, html: `<img src="assets/help/modulo-medidas-cores.jpg" alt="Tela de configuração do módulo, com medidas e cores da caixa e da porta/frente" loading="lazy"><p>Ao clicar no nome, na imagem ou nas medidas de um módulo na vitrine, abre a etapa <strong>2. Configure as medidas e os opcionais</strong>. Ali você ajusta:</p>
<ul>
...
<div class="po-help-tip">Itens marcados como <strong>Decorativo</strong> não têm preço nem entram no total do orçamento — servem só pra compor a visualização 3D.</div>` },
    { id: 'carrinho-pedido', title: `Adicionar ao carrinho e fechar o pedido`, html: `<img src="assets/help/novo-orcamento-carrinho.jpg" alt="Carrinho de pedido com dois módulos selecionados e o total estimado" loading="lazy"><p>Depois de configurar o módulo, clique em <strong>Adicionar este módulo ao pedido</strong> para colocá-lo no carrinho, que fica na coluna <strong>Seu Pedido</strong> à direita, com a lista de módulos selecionados e o <strong>Total estimado</strong>.</p>
<ul>
...
<div class="po-help-tip">Quer recomeçar do zero? Use <strong>Novo Pedido</strong>, na coluna do carrinho — ele avisa antes de esvaziar o pedido atual.</div>` }
  ...
  { id: 'conta', title: `Minha conta e configurações`, articles: [
    { id: 'configuracoes-gerais', title: `Unidade de medida e outras preferências`, html: `<img src="assets/help/configuracoes.jpg" alt="Painel de Configurações, com unidade de medida, unidade de peso e idioma" loading="lazy"><p>Clique no ícone de engrenagem (⚙) no canto superior direito para abrir o painel de <strong>Configurações</strong>. Nele você encontra:</p>
<ul>
...
<div class="po-help-tip">Campos como Pé direito e Rodapé da casa também existem, mas hoje ficam escondidos aqui — quando visíveis, os mesmos valores podem ser preenchidos direto na aba Projetos.</div>` },
    { id: 'margem-logo-dealer', title: `Margem de revenda e logo da sua loja (Dealer)`, html: `<img src="assets/help/configuracoes.jpg" alt="Painel de Configurações mostrando os campos de margem de revenda e logo da loja" loading="lazy"><p>Para contas de revenda (perfis Lojista, Contractor e Administrador), o painel de <strong>Configurações</strong> (ícone ⚙) tem campos extras que não aparecem para clientes finais:</p>
<ul>
...
<div class="po-help-tip">Se você não vê esses campos no seu painel de Configurações, é porque sua conta não tem permissão de revenda — fale com o administrador se precisar dela.</div>` },
    { id: 'trocar-senha', title: `Como trocar sua senha`, html: `<img src="assets/help/configuracoes.jpg" alt="Campo de Trocar senha, dentro do painel de Configurações" loading="lazy"><p>Abra o painel de <strong>Configurações</strong> (ícone ⚙ no canto superior direito) e role até o campo <strong>Trocar senha</strong>. Digite a nova senha (mínimo de 6 caracteres) e clique em <strong>Salvar nova senha</strong>. Não é preciso informar a senha antiga — a troca usa sua sessão já autenticada.</p>
...
<div class="po-help-tip">The <strong>All</strong> pill at the end of each filter bar clears that specific filter and shows every module at that level again.</div>` },
    { id: 'medidas-cores-preco', title: `Dimensions, colors and price`, html: `<img src="assets/help/modulo-medidas-cores.jpg" alt="Module configuration screen, with dimensions and box/door-front colors" loading="lazy"><p>Clicking a module's name, image, or dimensions in the catalog opens step <strong>2. Configure dimensions and options</strong>. There you can adjust:</p>
<ul>
...
<div class="po-help-tip">Items marked <strong>Decorative</strong> have no price and are not included in the quote total — they are only there to complete the 3D preview.</div>` },
    { id: 'carrinho-pedido', title: `Adding to the cart and placing the order`, html: `<img src="assets/help/novo-orcamento-carrinho.jpg" alt="Order cart with two selected modules and the estimated total" loading="lazy"><p>After configuring a module, click <strong>Add this module to the order</strong> to place it in the cart, shown in the <strong>Your Order</strong> column on the right, with the list of selected modules and the <strong>Estimated total</strong>.</p>
<ul>
...
<div class="po-help-tip">Want to start over? Use <strong>New Order</strong> in the cart column — it warns you before clearing the current order.</div>` }
  ...
  { id: 'conta', title: `My account and settings`, articles: [
    { id: 'configuracoes-gerais', title: `Unit of measurement and other preferences`, html: `<img src="assets/help/configuracoes.jpg" alt="Settings panel, with unit of measurement, weight unit and language" loading="lazy"><p>Click the gear icon (⚙) in the top-right corner to open the <strong>Settings</strong> panel. There you'll find:</p>
<ul>
...
<div class="po-help-tip">Fields like Ceiling height and Baseboard also exist, but are hidden here by default — when visible, the same values can be entered directly on the Projects tab.</div>` },
    { id: 'margem-logo-dealer', title: `Resale margin and your store logo (Dealer)`, html: `<img src="assets/help/configuracoes.jpg" alt="Settings panel showing the resale margin and store logo fields" loading="lazy"><p>For resale accounts (Dealer, Contractor and Administrator roles), the <strong>Settings</strong> panel (⚙ icon) has extra fields that don't show up for regular customers:</p>
<ul>
...
<div class="po-help-tip">Don't see these fields in your Settings panel? Your account doesn't have resale permissions — ask your administrator if you need them.</div>` },
    { id: 'trocar-senha', title: `Changing your password`, html: `<img src="assets/help/configuracoes.jpg" alt="&quot;Change password&quot; field, inside the Settings panel" loading="lazy"><p>Open the <strong>Settings</strong> panel (⚙ icon in the top-right corner) and scroll to the <strong>Change password</strong> field. Type your new password (at least 6 characters) and click <strong>Save new password</strong>. You don't need to enter your old password — the change uses your already-signed-in session.</p>
...
<div class="po-help-tip">Si eres Contractor, también existe una pestaña <strong>Plan de Corte</strong>, con la lista técnica de corte/producción generada a partir de los pedidos — solo aparece para ese perfil.</div>` },
    { id: 'conta-idioma-unidade', title: `Cuenta, idioma y unidad de medida`, html: `<img src="assets/help/configuracoes.jpg" alt="Panel de Configuración, con los selectores de idioma y unidad de medida" loading="lazy"><p>Para usar el portal necesitas una cuenta. Si todavía no tienes una, haz clic en <strong>Iniciar sesión</strong> en la parte superior de la pantalla, luego en <strong>Crear cuenta</strong> y completa nombre, correo electrónico, teléfono y contraseña. ¿Ya tienes cuenta? Ingresa tu correo y contraseña y haz clic en <strong>Iniciar sesión</strong> — o usa <strong>Continuar con Google</strong> para entrar más rápido, cuando esa opción esté disponible.</p>
...
<div class="po-help-tip">La pill <strong>Todas</strong>, al final de cada barra de filtro, borra ese filtro específico y vuelve a mostrar todos los módulos de ese nivel.</div>` },
    { id: 'medidas-cores-preco', title: `Medidas, colores y precio`, html: `<img src="assets/help/modulo-medidas-cores.jpg" alt="Pantalla de configuración del módulo, con medidas y colores de la caja y de la puerta/frente" loading="lazy"><p>Al hacer clic en el nombre, la imagen o las medidas de un módulo en la vitrina, se abre el paso <strong>2. Configura las medidas y los opcionales</strong>. Ahí puedes ajustar:</p>
<ul>
...
<div class="po-help-tip">Los artículos marcados como <strong>Decorativo</strong> no tienen precio ni entran en el total del presupuesto — solo sirven para completar la vista 3D.</div>` },
    { id: 'carrinho-pedido', title: `Agregar al carrito y cerrar el pedido`, html: `<img src="assets/help/novo-orcamento-carrinho.jpg" alt="Carrito de pedido con dos módulos seleccionados y el total estimado" loading="lazy"><p>Después de configurar un módulo, haz clic en <strong>Añadir este módulo al pedido</strong> para colocarlo en el carrito, que se muestra en la columna <strong>Tu Pedido</strong> a la derecha, con la lista de módulos seleccionados y el <strong>Total estimado</strong>.</p>
<ul>
...
<div class="po-help-tip">¿Quieres empezar de nuevo? Usa <strong>Nuevo Pedido</strong>, en la columna del carrito — te avisa antes de vaciar el pedido actual.</div>` }
  ...
  { id: 'conta', title: `Mi cuenta y configuración`, articles: [
    { id: 'configuracoes-gerais', title: `Unidad de medida y otras preferencias`, html: `<img src="assets/help/configuracoes.jpg" alt="Panel de Configuración, con unidad de medida, unidad de peso e idioma" loading="lazy"><p>Haz clic en el ícono de engranaje (⚙) en la esquina superior derecha para abrir el panel de <strong>Configuración</strong>. Ahí encontrarás:</p>
<ul>
...
<div class="po-help-tip">Campos como Altura de techo y Zócalo también existen, pero hoy están ocultos aquí — cuando están visibles, los mismos valores se pueden completar directamente en la pestaña Proyectos.</div>` },
    { id: 'margem-logo-dealer', title: `Margen de reventa y logo de tu tienda (Dealer)`, html: `<img src="assets/help/configuracoes.jpg" alt="Panel de Configuración mostrando los campos de margen de reventa y logo de la tienda" loading="lazy"><p>Para cuentas de reventa (perfiles Lojista/Dealer, Contractor y Administrador), el panel de <strong>Configuración</strong> (ícono ⚙) tiene campos extra que no aparecen para los clientes finales:</p>
<ul>
...
<div class="po-help-tip">¿No ves estos campos en tu panel de Configuración? Tu cuenta no tiene permisos de reventa — consulta a tu administrador si los necesitas.</div>` },
    { id: 'trocar-senha', title: `Cómo cambiar tu contraseña`, html: `<img src="assets/help/configuracoes.jpg" alt="Campo de Cambiar contraseña, dentro del panel de Configuración" loading="lazy"><p>Abre el panel de <strong>Configuración</strong> (ícono ⚙ en la esquina superior derecha) y desplázate hasta el campo <strong>Cambiar contraseña</strong>. Escribe la nueva contraseña (mínimo 6 caracteres) y haz clic en <strong>Guardar nueva contraseña</strong>. No necesitas ingresar la contraseña anterior — el cambio usa tu sesión ya autenticada.</p>
...
HELP_CONTENT.pt.push(
  ...
  { id: 'projetos-construtor', title: `Construtor de armário`, articles: [
    { id: 'construtor-basico', title: `Como funciona o Construtor`, html: `<img src="assets/help/construtor-armario.jpg" alt="Tela do Construtor de armário, com a lista de componentes à direita" loading="lazy"><p>O <strong>Construtor</strong> é a tela onde você monta os internos de um módulo dentro do seu projeto. Para abri-lo, selecione um módulo já inserido no ambiente e clique no botão flutuante <strong>Customizar</strong> (ícone de lápis).</p>
    ...
    { id: 'portas-gavetas-construtor', title: `Portas, gavetas e seleção em faixa`, html: `<img src="assets/help/construtor-armario.jpg" alt="Tela do Construtor de armário, com a lista de componentes à direita" loading="lazy"><p>Portas e gavetas são inseridas da mesma forma que qualquer outra peça no Construtor: selecione o vão e clique na peça desejada na lista à direita.</p>
      <ul>
  ...
  { id: 'projetos-cores', title: `Cores`, articles: [
    { id: 'trocar-cor-modulo', title: `Trocar a cor de um módulo`, html: `<img src="assets/help/cor-rapida-projeto.jpg" alt="Painel de &quot;Troca rápida de cor&quot; do projeto, com as abas Caixa, Porta/Frente e Painel" loading="lazy"><p>Cada módulo pode ter mais de uma parte colorida separadamente — por exemplo, a caixa (corpo) de uma cor e as portas/frentes de outra. Cada uma dessas partes é chamada de <strong>papel de cor</strong>.</p>
      <ul>
    ...
    { id: 'sku-referencia-rapida', title: `Referência (SKU): medida pronta`, html: `<img src="assets/help/modulo-selecionado-acoes.jpg" alt="Painel do módulo selecionado mostrando o campo Referência (SKU) junto com as medidas" loading="lazy"><p>Muitos módulos têm tamanhos de fábrica já catalogados, chamados de <strong>Referência (SKU)</strong> — em vez de digitar largura e altura manualmente, você escolhe um tamanho pronto de uma lista.</p>
      <ul>
...
HELP_CONTENT.en.push(
  ...
  { id: 'projetos-construtor', title: `Cabinet Builder`, articles: [
    { id: 'construtor-basico', title: `How the Builder works`, html: `<img src="assets/help/construtor-armario.jpg" alt="Cabinet Builder screen, with the component list on the right" loading="lazy"><p>The <strong>Builder</strong> is where you set up the internals of a module inside your project. To open it, select a module already placed in the room and click the floating <strong>Customize</strong> button (pencil icon).</p>
    ...
    { id: 'portas-gavetas-construtor', title: `Doors, drawers, and range selection`, html: `<img src="assets/help/construtor-armario.jpg" alt="Cabinet Builder screen, with the component list on the right" loading="lazy"><p>Doors and drawers are inserted the same way as any other part in the Builder: select the opening and click the part you want in the list on the right.</p>
      <ul>
  ...
  { id: 'projetos-cores', title: `Colors`, articles: [
    { id: 'trocar-cor-modulo', title: `Changing a module's color`, html: `<img src="assets/help/cor-rapida-projeto.jpg" alt="Project-wide &quot;quick color swap&quot; panel, with the Box, Door/Front and Panel tabs" loading="lazy"><p>Each module can have more than one colored part on its own — for example, the box (carcass) in one color and the doors/fronts in another. Each of these parts is called a <strong>color role</strong>.</p>
      <ul>
    ...
    { id: 'sku-referencia-rapida', title: `Reference (SKU): ready-made sizes`, html: `<img src="assets/help/modulo-selecionado-acoes.jpg" alt="Selected module panel showing the Reference (SKU) field along with the dimensions" loading="lazy"><p>Many modules have factory sizes already cataloged, called <strong>Reference (SKU)</strong> — instead of typing width and height by hand, you pick a ready-made size from a list.</p>
      <ul>
...
HELP_CONTENT.es.push(
  ...
  { id: 'projetos-construtor', title: `Creador de armarios`, articles: [
    { id: 'construtor-basico', title: `Cómo funciona el Creador`, html: `<img src="assets/help/construtor-armario.jpg" alt="Pantalla del Creador de armarios, con la lista de componentes a la derecha" loading="lazy"><p>El <strong>Creador</strong> es la pantalla donde arma los internos de un módulo dentro de su proyecto. Para abrirlo, seleccione un módulo ya colocado en el ambiente y haga clic en el botón flotante <strong>Customizar</strong> (ícono de lápiz).</p>
    ...
    { id: 'portas-gavetas-construtor', title: `Puertas, cajones y selección en franja`, html: `<img src="assets/help/construtor-armario.jpg" alt="Pantalla del Creador de armarios, con la lista de componentes a la derecha" loading="lazy"><p>Las puertas y cajones se insertan igual que cualquier otra pieza en el Creador: seleccione el vano y haga clic en la pieza deseada en la lista de la derecha.</p>
      <ul>
  ...
  { id: 'projetos-cores', title: `Colores`, articles: [
    { id: 'trocar-cor-modulo', title: `Cambiar el color de un módulo`, html: `<img src="assets/help/cor-rapida-projeto.jpg" alt="Panel de &quot;Cambio rápido de color&quot; del proyecto, con las pestañas Caja, Puerta/Frente y Panel" loading="lazy"><p>Cada módulo puede tener más de una parte con color propio — por ejemplo, la caja (cuerpo) de un color y las puertas/frentes de otro. Cada una de estas partes se llama <strong>rol de color</strong>.</p>
      <ul>
    ...
    { id: 'sku-referencia-rapida', title: `Referencia (SKU): medida lista`, html: `<img src="assets/help/modulo-selecionado-acoes.jpg" alt="Panel del módulo seleccionado mostrando el campo Referencia (SKU) junto con las medidas" loading="lazy"><p>Muchos módulos tienen tamaños de fábrica ya catalogados, llamados <strong>Referencia (SKU)</strong> — en vez de escribir ancho y alto a mano, elige un tamaño ya definido de una lista.</p>
      <ul>
...
HELP_CONTENT.pt.push(
  { id: 'meus-projetos', title: `Meus Projetos`, articles: [
    { id: 'gerenciar-projetos', title: `Gerenciar projetos: abrir, renomear, duplicar e excluir`, html: `<img src="assets/help/meus-projetos-lista.jpg" alt="Tela de Meus Projetos, com os cartões dos projetos salvos" loading="lazy"><p>Na aba <strong>Meus Projetos</strong> cada ambiente salvo aparece como um cartão com uma única imagem — a foto renderizada, se você já gerou uma, ou a vista 3D do ambiente enquanto não houver render.</p>
<ul>
...
<li>O link expira sozinho depois de 30 dias. Clicando em "Ver em 3D" de novo antes disso, o mesmo link é reaproveitado.</li>
  ...
  { id: 'pedidos', title: `Meus Pedidos`, articles: [
    { id: 'acompanhar-pedido', title: `Acompanhar o status do seu pedido`, html: `<img src="assets/help/meus-pedidos-lista.jpg" alt="Lista de Meus Pedidos, com status, data e valor de cada pedido" loading="lazy"><p>Depois de enviar um projeto pra virar pedido, acompanhe o andamento na aba <strong>Meus Pedidos</strong>: cada pedido mostra um selo de status que avança nesta ordem:</p>
<ul>
...
<div class="po-help-tip">Este recurso é destinado a contas de revenda — Dealer/lojista, Contractor e Administrador. Se você é um cliente final comprando diretamente, talvez não veja este botão.</div>` },
  ...
  { id: 'galeria', title: `Galeria`, articles: [
    { id: 'render-ia', title: `Gerar uma imagem realista (IA) do seu projeto`, html: `<img src="assets/help/galeria.jpg" alt="Aviso na Galeria de que as imagens são geradas por Inteligência Artificial" loading="lazy"><p>Depois de montar seu ambiente em 3D, você pode gerar uma imagem fotorrealista dele usando Inteligência Artificial.</p>
<ul>
...
<div class="po-help-tip">As imagens geradas por IA podem apresentar pequenas diferenças em relação ao produto real — o desenho 3D é sempre a referência fiel do projeto.</div>` },
    { id: 'galeria-publica', title: `Navegar na Galeria pública`, html: `<img src="assets/help/galeria.jpg" alt="Galeria de composições, com os filtros de ambiente, preço, largura e cor" loading="lazy"><p>A aba <strong>Galeria</strong> reúne ambientes montados por outros clientes e pode ser vista mesmo por quem ainda não tem conta — é a única aba visível pra um visitante sem login.</p>
<ul>
...
<li>Pra usar uma composição como ponto de partida (botão <strong>Personalizar</strong>) ou curtir um post, é preciso entrar na sua conta — um aviso de login aparece na hora, com opção de continuar com Google.</li>
  ...
  { id: 'plano-de-corte', title: `Plano de Corte`, articles: [
    { id: 'plano-de-corte-intro', title: `O que é o Plano de Corte`, html: `<img src="assets/help/plano-de-corte.jpg" alt="Tela do Plano de Corte, com a tabela de peças e as colunas de medidas" loading="lazy"><p>A aba <strong>Plano de Corte</strong> é uma ferramenta pra quem corta o próprio material: digite ou importe uma planilha (.xlsx, .csv ou .txt) com a lista de peças — medidas, espessura, cor, fita de borda e sentido do veio — e gere o preço e o diagrama de aproveitamento das chapas.</p>
...
HELP_CONTENT.en.push(
  { id: 'meus-projetos', title: `My Projects`, articles: [
    { id: 'gerenciar-projetos', title: `Managing projects: open, rename, duplicate and delete`, html: `<img src="assets/help/meus-projetos-lista.jpg" alt="&quot;My Projects&quot; screen, with the saved project cards" loading="lazy"><p>In the <strong>My Projects</strong> tab, each saved layout shows up as a card with a single image — the photorealistic render if you've generated one, or the 3D view while there is no render yet.</p>
<ul>
...
<li>The link expires on its own after 30 days. Clicking "View in 3D" again before then reuses the same link.</li>
  ...
  { id: 'pedidos', title: `My Orders`, articles: [
    { id: 'acompanhar-pedido', title: `Tracking your order's status`, html: `<img src="assets/help/meus-pedidos-lista.jpg" alt="&quot;My Orders&quot; list, with status, date and value for each order" loading="lazy"><p>After sending a project through as an order, track its progress in the <strong>My Orders</strong> tab: every order shows a status badge that moves through this sequence:</p>
<ul>
...
<div class="po-help-tip">This feature is meant for reseller accounts — Dealer, Contractor and Administrator. If you're an end customer buying directly, you may not see this button.</div>` },
  ...
  { id: 'galeria', title: `Gallery`, articles: [
    { id: 'render-ia', title: `Generating an AI photorealistic render`, html: `<img src="assets/help/galeria.jpg" alt="Notice on the Gallery that the images are generated by Artificial Intelligence" loading="lazy"><p>Once you've built your 3D layout, you can generate a photorealistic image of it using Artificial Intelligence.</p>
<ul>
...
<div class="po-help-tip">AI-generated images may differ slightly from the real product — the 3D drawing is always the faithful reference for the design.</div>` },
    { id: 'galeria-publica', title: `Browsing the public Gallery`, html: `<img src="assets/help/galeria.jpg" alt="Compositions gallery, with filters for room, price, width and color" loading="lazy"><p>The <strong>Gallery</strong> tab collects layouts built by other clients and can be viewed even without an account — it's the only tab visible to a signed-out visitor.</p>
<ul>
...
HELP_CONTENT.es.push(
  { id: 'meus-projetos', title: `Mis Proyectos`, articles: [
    { id: 'gerenciar-projetos', title: `Gestionar proyectos: abrir, renombrar, duplicar y eliminar`, html: `<img src="assets/help/meus-projetos-lista.jpg" alt="Pantalla de Mis Proyectos, con las tarjetas de los proyectos guardados" loading="lazy"><p>En la pestaña <strong>Mis Proyectos</strong>, cada ambiente guardado aparece como una tarjeta con una sola imagen — la foto renderizada, si ya generaste una, o la vista 3D del ambiente mientras no haya render.</p>
<ul>
...
<li>El enlace expira solo a los 30 días. Si haces clic en "Ver en 3D" de nuevo antes de eso, se reutiliza el mismo enlace.</li>
  ...
  { id: 'pedidos', title: `Mis Pedidos`, articles: [
    { id: 'acompanhar-pedido', title: `Seguir el estado de tu pedido`, html: `<img src="assets/help/meus-pedidos-lista.jpg" alt="Lista de Mis Pedidos, con estado, fecha y valor de cada pedido" loading="lazy"><p>Después de enviar un proyecto como pedido, sigue su avance en la pestaña <strong>Mis Pedidos</strong>: cada pedido muestra una etiqueta de estado que avanza en este orden:</p>
<ul>
...
<div class="po-help-tip">Esta función está pensada para cuentas de reventa — Distribuidor, Contractor y Administrador. Si eres un cliente final comprando directamente, es posible que no veas este botón.</div>` },
  ...
  { id: 'galeria', title: `Galería`, articles: [
    { id: 'render-ia', title: `Generar una imagen realista (IA) de tu proyecto`, html: `<img src="assets/help/galeria.jpg" alt="Aviso en la Galería de que las imágenes son generadas por Inteligencia Artificial" loading="lazy"><p>Una vez armado tu ambiente en 3D, puedes generar una imagen fotorrealista de él usando Inteligencia Artificial.</p>
<ul>
...
<div class="po-help-tip">Las imágenes generadas por IA pueden presentar pequeñas diferencias respecto al producto real — el dibujo 3D es siempre la referencia fiel del proyecto.</div>` },
    { id: 'galeria-publica', title: `Explorar la Galería pública`, html: `<img src="assets/help/galeria.jpg" alt="Galería de composiciones, con los filtros de ambiente, precio, ancho y color" loading="lazy"><p>La pestaña <strong>Galería</strong> reúne ambientes armados por otros clientes y se puede ver incluso sin tener cuenta — es la única pestaña visible para un visitante sin sesión iniciada.</p>
<ul>
...
<li>Para usar una composición como punto de partida (botón <strong>Personalizar</strong>) o para dar like a una publicación, hace falta iniciar sesión — aparece un aviso de inicio de sesión de inmediato, con opción de continuar con Google.</li>
  ...
  { id: 'plano-de-corte', title: `Plan de Corte`, articles: [
    { id: 'plano-de-corte-intro', title: `Para qué sirve el Plan de Corte`, html: `<img src="assets/help/plano-de-corte.jpg" alt="Pantalla del Plano de Corte, con la tabla de piezas y las columnas de medidas" loading="lazy"><p>La pestaña <strong>Plan de Corte</strong> es una herramienta para quienes cortan su propio material: escribe o importa una planilla (.xlsx, .csv o .txt) con la lista de piezas — medidas, espesor, color, cinta de borde y sentido de la veta — y genera el precio y el diagrama de aprovechamiento de las chapas.</p>
